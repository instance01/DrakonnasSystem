          ...
          <div class="container">
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="votes.php">Voting</a></li>
...
<p><a class="btn btn-lg btn-primary" role="button" href="#myModal" data-target="#myModal" data-toggle="modal">Sign in</a></p>            </div>
          </div>
        </div>
      </div>
    </div><!-- /.carousel -->
    ...
    <div class="container marketing">
        ...
        <li class='list-group-item'><a href="http://mineservers.com/server/8588/vote" target="_blank"><button class="btn btn-info">MineServers.com</button></a><img src="diamond.png" width="32px" height="32px" class="pull-right"></li>
        <li class='list-group-item'><a href="https://mcserverstatus.com/vote/18991" target="_blank"><button class="btn btn-info">McServerStatus.com</button></a><img src="diamond.png" width="32px" height="32px" class="pull-right"></li>
        <li class='list-group-item'><a href="http://minecraft-mp.com/server/19388/vote/" target="_blank"><button class="btn btn-info">Minecraft-MP.com</button></a><img src="diamond.png" width="32px" height="32px" class="pull-right"></li>
        <li class='list-group-item'><a href="http://www.planetminecraft.com/server/drakonnas-realm-pvp/vote/" target="_blank"><button class="btn btn-info">Planet Minecraft!</button></a><img src="diamond.png" width="32px" height="32px" class="pull-right"></li>
        <li class='list-group-item'><a href="https://minestatus.net/86809-drakonnas-realm/vote" target="_blank"><button class="btn btn-info">Minestatus</button></a><img src="diamond.png" width="32px" height="32px" class="pull-right"></li>
        <li class='list-group-item'><a href="http://minecraft-server-list.com/server/168623/vote/" target="_blank"><button class="btn btn-info">MSL</button></a><img src="diamond.png" width="32px" height="32px" class="pull-right"></li>
		</ul> 
